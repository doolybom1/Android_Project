...
public class MovieAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        String strActor = movieVOList.get(position).getDirector();
        ...
        if(!imageLink.isEmpty()){
            ...
            // imageLink에 있는 이미지를 다운로드하여 mHolder.m_image ImageView에 표시하라
    ...
    // 문자열에 HTML Tag가 들어있는 경우 해당문자열에 HTML 효과를 적용하기 위해 변환 method를 생성
