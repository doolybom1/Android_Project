...
/*
    FTS Ver 4
    Full Text Search 수행하는 방법에 3와 4가 있는데 최신 안드로이드 스튜디오에서는 FTS4를
    사용하도록 권장하고 매운 빠른 속도로 전체텍스트 검색을 할 수 있다.
...
public class MemoVO {
    ...
    // FTS를 사용하려면 id 칼럼이 반드시 int 형이고 db 칼럼 이름은 rowid로 설정을 해야 한다
